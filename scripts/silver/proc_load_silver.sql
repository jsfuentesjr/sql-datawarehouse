...
BEGIN
	...
	BEGIN
		...
		RAISE NOTICE 'Inserting data to: crm_cust_info';
		...
		RAISE NOTICE 'Inserting Data to: crm_prd_info';
		...
		RAISE NOTICE 'Inserting data to: crm_sales_details';
		...
		RAISE NOTICE 'Inserting data to: erp_cust_az12';
		...
		RAISE NOTICE 'Inserting data to: erp_loc_a101';
		...
		RAISE NOTICE 'Inserting data to: erp_px_cat_g1v2';
